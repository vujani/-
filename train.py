...
# SE-блок (тот же, что и в adaptive.py)
...
# Сеть шумоподавления с residual-соединением и улучшенной архитектурой
...
# Блоки для обработки низких и высоких частот (с residual-соединениями)
...
# Адаптивный блок с обучаемой маской и SE-вниманием
...
# Функция обучения с интеграцией адаптивного блока
def train_denoise_model(use_adaptive=True, freeze_adaptive=True):
    ...
    # Загружаем адаптивный блок, если требуется
    adaptive_block = None
    if use_adaptive:
